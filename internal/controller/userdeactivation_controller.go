...
// UserDeactivationReconciler reconciles a UserDeactivation object
type UserDeactivationReconciler struct {
	client.Client
...
func (r *UserDeactivationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *UserDeactivationReconciler) SetupWithManager(mgr ctrl.Manager) error {
