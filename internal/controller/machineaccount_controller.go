...
type MachineAccountReconciler struct {
	client.Client
...
func (r *MachineAccountReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *MachineAccountReconciler) SetupWithManager(mgr ctrl.Manager) error {
