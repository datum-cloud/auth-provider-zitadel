...
func (r *MachineAccountController) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		...
		_, err := r.Zitadel.CreateMachineUser(ctx, zitadel.MachineUserRequest{
			UserName:        string(machineAccount.GetUID()),
...
func (r *MachineAccountController) SetupWithManager(mgr ctrl.Manager) error {
