...
// TODO(temporary): replace with a real version bump once the companion Milo PR
// (refactor/machineaccount-to-identity-group) merges.
replace go.miloapis.com/milo => /Users/scotwells/repos/datum-cloud/milo
